...
INSERT INTO FORNECEDOR (CNPJ, NOMEFORNECEDOR, TELEFOFORNECEDOR, ENDERECOFORNECEDOR) 
...
INSERT INTO VENDAS(IDMATRICULA, CPF)
VALUES 	(1000,11223344556),
        ...
        (1002,67890123456),
        (1002,77889900112);
INSERT INTO LISTAPRODUTOS(IDVENDA, IDPRODUTO, QNTVENDIDO)
VALUES	(10000, 106, 2),
		(10000, 104, 1),
        (10001, 106, 3),
        (10002, 100, 5),
